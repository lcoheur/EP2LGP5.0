...
def readLangs(lang1, lang2):
    ...
    lines = open('new_training_file.txt', encoding='utf-8').\
        read().strip().split('\n')
...
input_lang, output_lang, pairs = prepareData('ept', 'lgp')
...
evaluateAndShowAttention("Eles gostam de massa .")

evaluateAndShowAttention("Gostas de brincar ?")

evaluateAndShowAttention("Não sei o que fazer .")
